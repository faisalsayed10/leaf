    ...
    <Flex align="center" justify="center" minH="90vh" maxW="750px" m="0 auto">
      ...
      >
        ...
        <Text fontSize="lg" px={4} mb={3} align="center">
          Hey there! 👋 It seems that this page needs you to be logged in to
          view it. You can go back if you ended up here accidentally or you can
          go forward and login with your account!
        </Text>
